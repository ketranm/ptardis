...
perl $P1/tokenizer.perl -threads 30 -l $S < ${P3}/all_${S}-${T}.${S} > ${P3}/all_${S}-${T}.${S}.tok
perl $P1/tokenizer.perl -threads 30 -l $T < ${P3}/all_${S}-${T}.${T} > ${P3}/all_${S}-${T}.${T}.tok
perl $P1/tokenizer.perl -threads 30 -l $S < ${P3}/newstest/newstest2014.${S} > ${P3}/newstest2014.${S}.tok
perl $P1/tokenizer.perl -threads 30 -l $T < ${P3}/newstest/newstest2014.${T} > ${P3}/newstest2014.${T}.tok

# BPE
if [ ! -f "${P3}/${S}.bpe" ]; then
    $PYTHON $P2/learn_bpe.py -s $SRC_CODE_SIZE < ${P3}/all_${S}-${T}.${S}.tok >${P3}/${S}.bpe
fi
if [ ! -f "${P3}/${T}.bpe" ]; then
    $PYTHON $P2/learn_bpe.py -s $SRC_CODE_SIZE < ${P3}/all_${S}-${T}.${T}.tok > ${P3}/${T}.bpe
fi
...
encode ${P3}/${S}.bpe ${P3}/newstest2014.${S}.tok ${P3}/newstest2014.${S}.tok.bpe
encode ${P3}/${T}.bpe ${P3}/newstest2014.${T}.tok ${P3}/newstest2014.${T}.tok.bpe
